...
/**
 * Network monitoring page (Signal).
 */
const Network = () => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 glass p-6 rounded-2xl min-h-[400px] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="w-full h-full bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-neon-blue/20 via-background to-background" />
          ...
          <p className="relative z-10 text-red-500/60 dark:text-gray-500 font-medium">
            Geographic Node Map
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="glass p-6 rounded-2xl">
            <h3 className="text-lg font-bold text-red-500 dark:text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((_, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-medium text-red-500 dark:text-white">
                      Interference Detected
                    </p>
                    <p className="text-xs text-red-500/60 dark:text-gray-500">
                      Node #EF-203 • 2m ago
                    </p>
                  </div>
                </div>
          ...
          <div className="glass p-6 rounded-2xl border-l-4 border-neon-green">
            <h3 className="text-lg font-bold text-red-500 dark:text-white mb-1">
              System Health
            </h3>
            <p className="text-3xl font-display font-bold text-neon-green">
              99.98%
            </p>
            <p className="text-sm text-red-500/60 dark:text-gray-400">
